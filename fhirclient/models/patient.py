...
class Patient(domainresource.DomainResource):
    ...
    def elementProperties(self):
        ...
        js.extend([
            ...
            ("usCoreRace", 
             'extension_http://hl7.org/fhir/us/core/StructureDefinition/us-core-race',
             uscorepatient.USCoreRace, False, None, False),
            ("usCoreEthnicity", 
             'extension_http://hl7.org/fhir/us/core/StructureDefinition/us-core-ethnicity',
             uscorepatient.USCoreEthnicity, False, None, False),
            ("usCoreBirthSex", 
             'extension_http://hl7.org/fhir/us/core/StructureDefinition/us-core-birthsex',
...
try:
    from . import uscorepatient
except ImportError:
    uscorepatient = sys.modules[__package__ + '.period']
